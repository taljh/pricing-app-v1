...
export default function ProfilePage() {
  ...
  useEffect(() => {
    async function loadUserProfile() {
      ...
      // استدعاء معلومات الملف الشخصي من قاعدة البيانات
          ...
          <TabsContent value="security">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  إعدادات الأمان والخصوصية لحسابك
                </CardDescription>
              </CardHeader>
              ...
              <CardContent className="space-y-6">
                <div className="space-y-2">
                  ...
                  <div className="bg-gray-50 p-4 rounded-md">
                    ...
                    <p className="text-sm text-gray-600"><strong>تاريخ الإنشاء:</strong> {new Date(user.created_at).toLocaleDateString('ar-SA')}</p>
